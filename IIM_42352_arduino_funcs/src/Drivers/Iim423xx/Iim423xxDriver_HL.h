 ...
 *  Dependant of chip
 */
#if (defined(ICM42600) || defined(ICM42622) || defined(ICM42633) || defined(ICM42686) || defined(ICM42688)||defined(IIM42352)||defined(IIM42351))
	/* 
	...
	#define ICM_PART_DEFAULT_OIS_MODE IIM423XX_SENSOR_CONFIG2_OIS_MODE_8KHZ
#endif
 ...
 *  Dependant of chip
 */	
#if (defined(IIM42351) || defined(IIM42352))
